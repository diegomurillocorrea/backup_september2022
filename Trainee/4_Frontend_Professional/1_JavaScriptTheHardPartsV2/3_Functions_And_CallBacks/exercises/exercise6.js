...
Create a function called reduce that takes an 
array and reduces the elements to a single value. 
...
Here's how it works. 
The function has an "accumulator value" which starts as 
the initialValue and accumulates the output of each loop. 
...
Finally add(5, 3) brings it to 8, 
which is returned.
